...
import { SosAlertHandler } from '@/components/dashboard/staff/sos-alert-handler';

const navItems = [
  { href: '/staff/dashboard', icon: Users, label: 'Patient Triage' },
  { href: '/staff/chats', icon: MessageSquare, label: 'Chats' },
        ...
        <header className="flex h-14 items-center gap-4 border-b bg-card px-4 sm:px-6 sticky top-0 z-30">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild><Link href="/staff/profile">Profile</Link></DropdownMenuItem>
              <DropdownMenuItem asChild><Link href="/staff/settings">Settings</Link></DropdownMenuItem>
              <DropdownMenuSeparator />
